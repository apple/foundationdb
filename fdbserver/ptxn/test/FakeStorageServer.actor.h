...
#if defined(NO_INTELLISENSE) && !defined(FDBSERVER_TEAM_TEST_FAKESTORAGESERVER_ACTOR_G_H)
#define FDBSERVER_TEAM_TEST_FAKESTORAGESERVER_ACTOR_G_H
#include "fdbserver/ptxn/test/FakeStorageServer.actor.g.h"
#elif !defined(FDBSERVER_TEAM_TEST_FAKESTORAGESERVER_ACTOR_H)
#define FDBSERVER_TEAM_TEST_FAKESTORAGESERVER_ACTOR_H
...
#endif // FDBSERVER_TEAM_TEST_FAKESTORAGESERVER_ACTOR_H
