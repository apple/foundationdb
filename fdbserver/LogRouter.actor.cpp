...
struct LogRouterData {
	struct TagData : NonCopyable, public ReferenceCounted<TagData> {
		...
		TagData(TagData&& r) noexcept : version_messages(std::move(r.version_messages)), tag(r.tag), popped(r.popped), durableKnownCommittedVersion(r.durableKnownCommittedVersion) {}
