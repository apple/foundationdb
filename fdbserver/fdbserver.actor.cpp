...
enum {
	...
	OPT_FLOW_PROCESS_NAME, OPT_FLOW_PROCESS_ENDPOINT, OPT_IP_TRUSTED_MASK, OPT_KMS_CONN_DISCOVERY_URL_FILE, OPT_KMS_CONNECTOR_TYPE, OPT_KMS_REST_ENABLE_NOT_SECURE_CONECTION, OPT_KMS_CONN_VALIDATION_TOKEN_DETAILS,
...
CSimpleOpt::SOption g_rgOptions[] = {
	...
	{ OPT_KMS_REST_ENABLE_NOT_SECURE_CONECTION,  "--kms-rest-enable_not_secure_connection", SO_REQ_SEP },
...
private:
	...
	void parseArgsInternal(int argc, char* argv[]) {
		...
		while (args.Next()) {
			...
			case OPT_KMS_REST_ENABLE_NOT_SECURE_CONECTION: {
				knobs.emplace_back("rest_kms_enable_not_secure_connection", args.OptionArg());
				break;
			}
