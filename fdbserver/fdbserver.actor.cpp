...
enum {
	...
	OPT_KMS_CONN_GET_ENCRYPTION_KEYS_ENDPOINT, OPT_KMS_CONN_GET_LATEST_ENCRYPTION_KEYS_ENDPOINT, OPT_KMS_CONN_GET_BLOB_METADATA_ENDPOINT, OPT_NEW_CLUSTER_KEY, OPT_AUTHZ_PUBLIC_KEY_FILE, OPT_USE_FUTURE_PROTOCOL_VERSION, OPT_KMS_ENABLE_RECRUITMENT
};
...
CSimpleOpt::SOption g_rgOptions[] = {
	...
	{ OPT_KMS_ENABLE_RECRUITMENT,                "--kms-enable-recruitment",     			SO_NONE },
...
private:
	...
	void parseArgsInternal(int argc, char* argv[]) {
		...
		while (args.Next()) {
			...
			case OPT_KMS_ENABLE_RECRUITMENT: {
				knobs.emplace_back("rest_kms_enable_recruitment", "true");
				break;
			}
