...
public:
	...
	bool DECAY_TXN_RATE_ON_LEASE_EXPIRATION;
	...
	double INITIAL_READ_QUEUE_MULTIPLIER;
	double READ_QUEUE_REDUCTION_RATE;
	double READ_QUEUE_INCREASE_RATE;

	double STORAGE_SERVER_LIST_FETCH_TIMEOUT;

	int64_t MAX_READ_QUEUE;
