...
public:
	...
	int START_TRANSACTION_SYSTEM_AND_DEFAULT_MAX_QUEUE_SIZE;
	int START_TRANSACTION_BATCH_MAX_QUEUE_SIZE;
	int KEY_LOCATION_MAX_QUEUE_SIZE;
	bool BATCH_TXN_ALWAYS_QUEUING_REQ; // Always add batch txn to batch queue (as long as the batch queue has space),
	                                   // even when batch rate is low
