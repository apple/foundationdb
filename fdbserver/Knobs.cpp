...
void ServerKnobs::initialize(bool randomize, ClientKnobs* clientKnobs, bool isSimulated) {
    ...
    */
    ...
    init( CC_PEER_HEALTH_CHECKING_INTERVAL,                    15.0 );
    init(PEER_DEGRADATION_INTERVAL,   120);
    init(MAX_PEER_DEGRADATION_TO_EXCLUDE, 5);
    init(DEGRADED_PEER_EXPIRATION_INTERVAL, 300.0);
    ...
    init( ENABLE_PEER_HEALTH_MONITOR,                            true);
    init( PEER_HEALTH_MONITOR_INTERVAL,                      	 60.0);
    init( PEER_LATENCY_DEGRADATION_THRESHOLD,                  	 0.025);
