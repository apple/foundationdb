	...
	std::string whitelistBinPaths)
{
	...
	commitData.txnStateStore = keyValueStoreLogSystem(commitData.logAdapter, proxy.id(), 2e9, ProtocolVersion::withNoKVMemPrefixCompressedSnapshots(), true, true, true);
