...
// public:
// 	class RocksCheckpointIterator : public ICheckpointIterator {
// 	public:
// 		RocksCheckpointIterator(IKeyValueStore* kvs, const KeyRange& range, const UID& logId)
// 		  : reader(kvs), range(range), logId(logId) {}

// 		~RocksCfCheckpointIterator() {}
