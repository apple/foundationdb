...
public:
	...
	virtual location getNextCommitLocation() = 0; // If commit() were to be called, all buffered writes would be written
	                                              // starting at `location`.
	virtual location
	getNextPushLocation() = 0; // If push() were to be called, the pushed data would be written starting at `location`.
