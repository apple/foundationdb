...
public:
	...
	virtual Future<Void> pollMoveKeysLock(MoveKeysLock lock, Reference<DDEnabledState> ddEnabledState) const = 0;
};
...
public:
	...
	Future<Void> pollMoveKeysLock(MoveKeysLock lock, Reference<DDEnabledState> ddEnabledState) const override;
};
