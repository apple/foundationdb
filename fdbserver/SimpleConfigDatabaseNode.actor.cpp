...
class SimpleConfigDatabaseNodeImpl {
	...
	ACTOR static Future<ConfigGeneration> getGeneration(SimpleConfigDatabaseNodeImpl* self) {
	...
	// serializability
	ACTOR static Future<Void> getNewGeneration(SimpleConfigDatabaseNodeImpl* self,
