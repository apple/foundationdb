...
// more load to the cluster (Maybe some visualization tools is needed to show the trend of metrics) Note: this workload
// may not be proper for simulation
struct WriteTagThrottlingWorkload : TestWorkload {
    ...
    virtual std::string description() { return "WriteThrottlingWorkload"; }
