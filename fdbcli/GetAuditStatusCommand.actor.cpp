...
CommandFactory getAuditStatusFactory(
    "get_audit_status",
    CommandHelp(
        "get_audit_status <Type> <id|recent> [ARGs]",
        ...
        "Only 'ha' and `replica` and `shardglobal` and "
        "`shardlocal` and `physicalshardmigration` `Type' is supported currently. If specified, `Count' is how many\n"
