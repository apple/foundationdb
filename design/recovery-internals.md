...
The logic of locking the tLogs is implemented in `epochEnd()` function in [LogSystem.cpp](https://github.com/apple/foundationdb/blob/main/fdbserver/LogSystem.cpp).
