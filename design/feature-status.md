...
|Encryption at Rest|Status uncertain|Encrypted database contents. Design doc [here](https://github.com/apple/foundationdb/blob/main/design/encryption-data-at-rest.md) talks about a "proposal".  We should clarify if this has ever been "production supported".  This functionality is not used at Apple and is not tested regularly.|None|Long term status under review.|
