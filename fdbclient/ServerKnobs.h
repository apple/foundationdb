...
public:
	...
	bool ROCKSDB_AVOID_FLUSH_DURING_SHUTDOWN;
	int64_t ROCKSDB_COMPACTION_READAHEAD_SIZE;
	int64_t ROCKSDB_WRITE_BUFFER_SIZE;
	int ROCKSDB_COMPRESSION;
	int ROCKSDB_COMPRESSION_MAX_DICT_BYTES;
	int ROCKSDB_CHECKSUM;
	int64_t ROCKSDB_BLOCK_SIZE;
	bool ROCKSDB_WHOLE_KEY_FILTERING;
	int ROCKSDB_FORMAT_VERSION;
