...
public:
	...
	int DD_DATA_MOVE_TRACE_SEV_LEVEL; // TraceEvent severity level for data move.
	...
	// int64_t PHYSICAL_SHARD_SIZE_MAX_BYTES;
	int64_t PHYSICAL_SHARD_SIZE_MIN_BYTES;
	// int64_t PHYSICAL_SHARD_COUNT_PER_TEAM_MIN;
