...
public:
	...
	int ROCKSDB_WRITE_THREAD_PRIORITY;
	...
	int ROCKSDB_COMPRESSION_OPTS_WINDOW_BIT;
	int ROCKSDB_COMPRESSION_OPTS_LEVEL;
	int ROCKSDB_COMPRESSION_OPTS_STRATEGY;
	int ROCKSDB_BOTTOM_LAYER_COMPRESSION_TYPE;
	bool ROCKSDB_THROTTLE_READS;
