...
public:
	...
	bool CONSISTENCY_CHECK_DISTRIBUTED;
	bool CONSISTENCY_CHECK_AGGRESSIVE_RUN;
	bool CONSISTENCY_CHECK_COMPLETE_CHECK;
	bool CONSISTENCY_CHECK_ONE_TIME_CHECK;
	int CONSISTENCY_CHECK_RETRY_DEPTH_MAX;
	int CONSISTENCY_CHECK_DISTRIBUTED_WIGGLE_ROOM;
	std::string CONSISTENCY_CHECK_RANGE_BEGIN;
	std::string CONSISTENCY_CHECK_RANGE_END;
