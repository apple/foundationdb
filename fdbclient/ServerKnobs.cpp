...
void ServerKnobs::initialize(Randomize randomize, ClientKnobs* clientKnobs, IsSimulated isSimulated) {
	...
	*/
	...
	init( DD_RELOCATOR_STARTUP_RESTORED_MOVE_MAX_DELAY,            0 ); if (randomize && BUGGIFY ) DD_RELOCATOR_STARTUP_RESTORED_MOVE_MAX_DELAY = 1;
	init( DD_RELOCATOR_STARTUP_UNRESTORED_MOVE_MAX_DELAY,          0 ); if (randomize && BUGGIFY ) DD_RELOCATOR_STARTUP_UNRESTORED_MOVE_MAX_DELAY = 1;
	init( DD_RELOCATOR_LATENCY_SKETCH_ACCURACY,                 0.01 );
