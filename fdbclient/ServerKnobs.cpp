...
void ServerKnobs::initialize(Randomize randomize, ClientKnobs* clientKnobs, IsSimulated isSimulated) {
	...
	*/
	...
	init( DD_LONG_STORAGE_QUEUE_MAJORITY_PERCENTILE,             0.5 ); if( randomize && BUGGIFY ) DD_LONG_STORAGE_QUEUE_MAJORITY_PERCENTILE = deterministicRandom()->random01();
 	init( DD_MIN_TEAM_PERCENTAGE_TO_SELECT_LONG_QUEUE_THRESHOLD, 0.5 ); if( randomize && BUGGIFY ) DD_MIN_TEAM_PERCENTAGE_TO_SELECT_LONG_QUEUE_THRESHOLD = deterministicRandom()->random01();
