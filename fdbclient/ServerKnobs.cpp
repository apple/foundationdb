...
void ServerKnobs::initialize(Randomize randomize, ClientKnobs* clientKnobs, IsSimulated isSimulated) {
	...
	*/
	...
	init( DD_RELOCATOR_STARTUP_RESTORED_MOVE_MAX_DELAY,            0 ); if( randomize && BUGGIFY ) DD_RELOCATOR_STARTUP_RESTORED_MOVE_MAX_DELAY = deterministicRandom()->randomInt(1, 10);
	init( DD_RELOCATOR_STARTUP_UNRESTORED_MOVE_MAX_DELAY,          0 ); if( randomize && BUGGIFY ) DD_RELOCATOR_STARTUP_UNRESTORED_MOVE_MAX_DELAY = deterministicRandom()->randomInt(1, 10);
