...
void ServerKnobs::initialize(Randomize randomize, ClientKnobs* clientKnobs, IsSimulated isSimulated) {
	...
	*/
	...
	init( TESTING_AUDIT_STORAGE_THROTTLING,                    false );
	init( CONCURRENT_AUDIT_TASK_COUNT_MAX,                        50 ); if ( isSimulated ) CONCURRENT_AUDIT_TASK_COUNT_MAX = TESTING_AUDIT_STORAGE_THROTTLING ? deterministicRandom()->randomInt(1, CONCURRENT_AUDIT_TASK_COUNT_MAX+1) : 10000;
