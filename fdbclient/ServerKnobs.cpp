...
void ServerKnobs::initialize(Randomize randomize, ClientKnobs* clientKnobs, IsSimulated isSimulated) {
	...
	*/
	...
	init( TR_REDUNDANT_MACHINE_TEAM_RATIO_THRESHOLD,          0 ); if( isSimulated ) TR_REDUNDANT_MACHINE_TEAM_RATIO_THRESHOLD = deterministicRandom()->random01();
	init( TR_REDUNDANT_SERVER_TEAM_RATIO_THRESHOLD,           0 ); if( isSimulated ) TR_REDUNDANT_SERVER_TEAM_RATIO_THRESHOLD = deterministicRandom()->random01();
