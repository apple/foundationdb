...
#ifndef FDBCLIENT_CLIENTSTATUSSTATS_H
#define FDBCLIENT_CLIENTSTATUSSTATS_H
...
struct ClientStatusStats {
	// The number of the examples from the client, could be greater than examples.size() as examples can be dropped if
...
// This class allows adding examples to the ClientStatusStats object,
struct ClientStatusStatsCollector : ClientStatusStats {
...
#endif // FDBCLIENT_CLIENTSTATUSSTATS_H