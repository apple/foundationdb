...
public:
	...
	double FORCE_PURGE_WAIT_BLOBBIFY_TIMEOUT;
	...
	int BLOB_MANAGER_PURGE_GRANULE_PARALLELISM;
	double BGCC_TIMEOUT;
	...
	double REST_KMS_CONNECTOR_INIT_REQUEST_RETRY_DELAY;
	double REST_KMS_CONNECTOR_MAX_REQUEST_RETRY_DELAY;
