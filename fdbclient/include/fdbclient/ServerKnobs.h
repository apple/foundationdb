...
public:
	...
	double TR_REDUNDANT_MACHINE_TEAM_RATIO_THRESHOLD; // machineTeamRemover will only remove teams if existing team
	                                                  // number is p% more than the desired team number.
	double TR_REDUNDANT_SERVER_TEAM_RATIO_THRESHOLD; // serverTeamRemover will only remove teams if existing team
	                                                 // number is p% more than the desired team number.
