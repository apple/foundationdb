...
public:
	...
	bool DD_ALLOW_UNLIMITED_RESTORED_DATA_MOVES;
	int DD_RELOCATOR_STARTUP_MAX_DELAY;
	int DD_MAX_ACTIVE_RELOCATIONS;
	...
	int MOVEKEYS_SUCCESS_DELAY;
	int MOVEKEYS_RETRIABLE_ERROR_DELAY;
