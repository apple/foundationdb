...
public:
	...
	int PRIORITY_BASED_AUDIT_RANGE_BATCH_SIZE; // Keep small
	double PRIORITY_BASED_AUDIT_REST_FACTOR; // audit period = finish time * PERIOD_FACTOR
	double PRIORITY_BASED_AUDIT_MIN_REST_TIME_PER_ROUND;
	int PRIORITY_BASED_AUDIT_QUEUE_MAX_SIZE;
	double PRIORITY_BASED_AUDIT_POLLING_TIME;
	double PRIORITY_BASED_AUDIT_TRACKER_PERIOD;
	double PRIORITY_BASED_AUDIT_TRACKER_SPEEDUP_FACTOR;
	double PRIORITY_BASED_AUDIT_TRACKER_SLOWDOWN_FACTOR;
