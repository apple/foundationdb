...
public:
	...
	bool operator==(BulkDumpState const& rhs) const {
	...
	BulkDumpState generateRangeTask(KeyRange const& taskRange) {
	...
	BulkDumpState generateBulkDumpMetadataToPersist(BulkLoadManifest const& manifest) {
