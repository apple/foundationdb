...
//	RestorableFileSet(Void) {} //work around compilation
//
//	RestorableFileSet(RestorableFileSet &fileSet) {
//		targetVersion = fileSet.targetVersion;
//		logs = fileSet.logs;
//		ranges = fileSet.ranges;
//		snapshot = fileSet.snapshot;
//	}
//
};
