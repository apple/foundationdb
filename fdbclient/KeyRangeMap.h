...
public:
	...
	void operator=(KeyRangeMap&& r) noexcept { mapEnd = std::move(r.mapEnd); RangeMap<Key,Val,KeyRangeRef,Metric,MetricFunc>::operator=(std::move(r)); }
...
public:
	...
	void operator=(CoalescedKeyRefRangeMap&& r) noexcept { mapEnd = std::move(r.mapEnd); RangeMap<KeyRef, Val, KeyRangeRef,Metric,MetricFunc>::operator=(std::move(r)); }
...
public:
	...
	void operator=(CoalescedKeyRangeMap&& r) noexcept { mapEnd = std::move(r.mapEnd); RangeMap<Key,Val,KeyRangeRef,Metric,MetricFunc>::operator=(std::move(r)); }
	void insert( const KeyRangeRef& keys, const Val& value );
