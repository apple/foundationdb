...
template struct SerializedMsg<ArenaReader, FailureMonitoringReply>;
template struct SerializedMsg<ArenaReader, GetHealthMetricsReply>;
template struct SerializedMsg<ArenaReader, GetKeyServerLocationsReply>;
template struct SerializedMsg<ArenaReader, GetReadVersionReply>;
template struct SerializedMsg<ArenaReader, Optional<LeaderInfo>>;
