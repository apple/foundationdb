...
DatabaseContext::DatabaseContext(
	...
	transactionBatchReadVersionsCompleted("BatchPriorityReadVersionsComplete", cc), transactionDefaultReadVersionsCompleted("DefaultPriorityReadVersionsComplete", cc), 
	transactionImmediateReadVersionsCompleted("ImmediatePriroityReadVersionsComplete", cc), transactionLogicalReads("LogicalUncachedReads", cc), transactionPhysicalReads("PhysicalReadRequests", cc), 
