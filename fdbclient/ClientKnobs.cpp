...
void ClientKnobs::initialize(Randomize randomize) {
	...
	init( CONSISTENCY_CHECK_RANGE_BEGIN,             "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN = "";
	init( CONSISTENCY_CHECK_RANGE_END,       "\xff\xff" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END = "a";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_A,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_A = "a";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_A,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_A = "b";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_B,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_B = "b";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_B,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_B = "c";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_C,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_C = "c";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_C,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_C = "d";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_D,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_D = "d";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_D,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_D = "e";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_E,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_E = "e";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_E,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_E = "f";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_F,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_F = "f";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_F,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_F = "g";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_G,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_G = "g";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_G,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_G = "h";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_H,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_H = "h";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_H,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_H = "i";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_I,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_I = "i";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_I,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_I = "j";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_J,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_J = "j";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_J,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_J = "k";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_K,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_K = "k";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_K,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_K = "l";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_L,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_L = "l";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_L,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_L = "m";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_M,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_M = "m";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_M,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_M = "n";
	init( CONSISTENCY_CHECK_RANGE_BEGIN_MORE_N,      "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_BEGIN_MORE_N = "n";
	init( CONSISTENCY_CHECK_RANGE_END_MORE_N,        "" ); if( randomize && BUGGIFY ) CONSISTENCY_CHECK_RANGE_END_MORE_N = "o";
