...
void ClientKnobs::initialize(Randomize randomize) {
	...
	init( METACLUSTER_RESTORE_MISSING_TENANTS_BATCH_SIZE, 1000 ); if ( randomize && BUGGIFY ) METACLUSTER_RESTORE_MISSING_TENANTS_BATCH_SIZE = 1 + deterministicRandom()->randomInt(0, 3);
