...
public:
	...
	ThreadFuture<Void> updateClusterSharedStateMap(std::string connectionRecord, Reference<IDatabase> db);
	void clearClusterSharedStateMapEntry(std::string connectionRecord);
