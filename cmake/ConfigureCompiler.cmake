...
env_set(GEN_PROFILE OFF BOOL "Compile with instrumentation, then the binary will generate profile after successful run")
env_set(USE_PROFILE "" STRING "Compile with profile, it's called Profile Guided Optimization")
...
if(WIN32)
  ...
  if (CLANG)
    ...
    if (NOT (USE_PROFILE STREQUAL ""))
      add_compile_options(-Wno-error=profile-instr-out-of-date)
      add_compile_options(-fprofile-instr-use=${USE_PROFILE})
      add_link_options(-fprofile-instr-use=${USE_PROFILE})
    endif()
  endif()
  if (USE_WERROR)
