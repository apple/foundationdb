...
if(WIN32)
  ...
  if (CLANG)
    ...
    if (GENERATE_INSTR_PROFILE)
      add_compile_options(-fprofile-instr-generate)
      add_link_options(-fprofile-instr-generate)
    endif()
    if (NOT (USE_INSTR_PROFILE STREQUAL ""))
      add_compile_options(-Wno-error=profile-instr-out-of-date)
      add_compile_options(-fprofile-instr-use=${USE_INSTR_PROFILE})
      add_link_options(-fprofile-instr-use=${USE_INSTR_PROFILE})
    endif()
  endif()
  if (USE_WERROR)
