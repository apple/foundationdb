...
* Added an admission control pipeline for Data Distribution that caps the number of relocations DD tracks at once (default 1000), applied to relocations of all priorities including operator-triggered excludes, to prevent DD from being overwhelmed. `(PR #13243) <https://github.com/apple/foundationdb/pull/13243>`_ and `(PR #13402) <https://github.com/apple/foundationdb/pull/13402>`_
