...
extern void debugFileCheck(std::string context, std::string file, void const* data, int64_t offset, int length);

// Updates the in-memory copy of tracked data at a given offset
extern void debugFileSet(std::string context, std::string file, void const* data, int64_t offset, int length);
