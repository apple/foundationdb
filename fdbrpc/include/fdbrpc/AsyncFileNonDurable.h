...
public:
	StringRef getClassName() override { return "AsyncFileDetachable"_sr; }
...
public:
	StringRef getClassName() override { return "AsyncFileNonDurable"_sr; }
...
public:
	...
	~AsyncFileNonDurable() override = default;

	void addref() override { ReferenceCounted<AsyncFileNonDurable>::addref(); }

	void delref() override {
		if (delref_no_destroy()) {
			if (!filesBeingDeleted.contains(filename)) {
