...
std::pair<int, int> actorFuzzTests() {
	...
	testsOK += testFuzzActor(&actorFuzz6,
	                         "actorFuzz6",
	                         (vector<int>(),
	                          320321,
	                          266526,
	                          ...
	                          463730,
	                          945289));
	testsOK += testFuzzActor(&actorFuzz7,
	                         "actorFuzz7",
	                         (vector<int>(),
	                          406152,
	                          478841,
	...
	testsOK += testFuzzActor(
	    &actorFuzz17, "actorFuzz17", (vector<int>(), 249436, 416782, 249436, 416782, 249436, 416782, 299183));
	testsOK += testFuzzActor(&actorFuzz18, "actorFuzz18", (vector<int>(), 337649, 395297, 807261, 517901));
	testsOK +=
	    testFuzzActor(&actorFuzz19,
	                  "actorFuzz19",
	...
	testsOK += testFuzzActor(
	    &actorFuzz26, "actorFuzz26", (vector<int>(), 520263, 306397, 944232, 366272, 700651, 146918, 191890));
