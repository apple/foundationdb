...
public class MappedKeyValueV2 extends KeyValue {
	...
	public static MappedKeyValueV2 fromBytes(byte[] bytes, int[] lengths) {
		...
		// System.out.println("Hfu5 key bytes " + lengths[offset.lengths] + " index " + offset.lengths);
		byte[] key = takeBytes(offset, bytes, lengths);
		// System.out.println("Hfu5 value bytes " + lengths[offset.lengths]+ " index " + offset.lengths);
		byte[] value = takeBytes(offset, bytes, lengths);
		// System.out.println("Hfu5 ParamsBuffer bytes " + lengths[offset.lengths] + " index " + offset.lengths);
