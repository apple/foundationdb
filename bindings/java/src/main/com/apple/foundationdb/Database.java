...
public interface Database extends AutoCloseable, TransactionContext {
	...
	/**
	 * Runs {@link #flushBlobRange(byte[] beginKey, byte[] endKey, boolean compact)} on the default executor.
	 *
	 * @param beginKey start of the key range
	 * @param endKey end of the key range
	...
	/**
	 * Runs {@link #flushBlobRange(byte[] beginKey, byte[] endKey, boolean comapct, long version)} on the default executor.
	 *
	 * @param beginKey start of the key range
	 * @param endKey end of the key range
	 * @param compact force compact or just flush
