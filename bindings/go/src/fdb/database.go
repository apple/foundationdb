...
// ErrClientNotReady is returned when client is not yet ready; the call should be retried.
...
// NOTE: ErrClientNotReady will be returned while client is initializing and should be retried.
