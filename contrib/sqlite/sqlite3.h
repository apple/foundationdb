...
//
// If the scan completed without error then SQLITE_OK is returned.
//
// The scan will stop on the first error, set *pBadPage to the page number
// and return the error code.
//
// If the error code returned is SQLITE_CORRUPT then a pager codec
// error was encountered, and the following will be set:
//   *pBadPageType will be -1 for unknown or >=0 for the bad page's
