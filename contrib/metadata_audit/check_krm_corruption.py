...
def main():
    ...
    parser.add_argument('--dry-run', action='store_true', default=True, help='Only show what would be repaired (default: True)')
    parser.add_argument('--execute-repair', action='store_true', help='Actually execute the repair (disables dry-run)')
