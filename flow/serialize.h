...
static uint64_t size_limits[] = { 0ULL,
	                              255ULL,
	                              65535ULL,
	                              16777215ULL,
	                              4294967295ULL,
...
public:
	...
	BinaryWriter(BinaryWriter&& rhs)
	  : data(rhs.data), size(rhs.size), allocated(rhs.allocated), m_protocolVersion(rhs.m_protocolVersion) {
		rhs.size = 0;
		rhs.allocated = 0;
		rhs.data = 0;
	}
