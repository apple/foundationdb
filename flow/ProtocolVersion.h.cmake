...
public:
	...
	constexpr bool operator==(ProtocolVersion const other) const { return version() == other.version(); }
	constexpr bool operator!=(ProtocolVersion const other) const { return version() != other.version(); }
	constexpr bool operator<=(ProtocolVersion const other) const { return version() <= other.version(); }
	constexpr bool operator>=(ProtocolVersion const other) const { return version() >= other.version(); }
	constexpr bool operator<(ProtocolVersion const other) const { return version() < other.version(); }
...
struct Traceable<ProtocolVersion> : std::true_type {
	static std::string toString(ProtocolVersion const& protocolVersion) {
...
struct Traceable<SWVersion> : std::true_type {
	static std::string toString(SWVersion const& swVersion) {
