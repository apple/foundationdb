...
ERROR( audit_storage_schedule_failed, 1233, "Audit is failed to be scheduled" )
ERROR( cancel_audit_storage_schedule_failed, 1234, "Audit schedule is failed to be cancelled" )
