...
ERROR( audit_storage_exeed_max, 1222, "Exceeded the max number of allowed concurrent audit storage requests" )
ERROR( audit_storage_error, 1223, "Found data corruption" )
