...
public:
	...
	bool TRACING_SPAN_ATTRIBUTES_ENABLED;
	...
	double TAG_AND_FORWARD_DELAY_THRESHOLD;
	...
	bool RUN_LOOP_PRIORITIZE_EXTERNAL_THREADS;
	bool RUN_LOOP_PRIORITIZE_THREAD_RETURNS;
