...
ERROR( page_header_version_not_supported, 1066, "Page header version is not supported" )
...
ERROR( unexpected_encoding_type, 1069, "Page content decoding failed" )
ERROR( encryption_key_not_found, 1070, "Encryption key not found" )
