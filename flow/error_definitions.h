...
ERROR( range_locks_access_denied, 2118, "Access is denied because a range lock is present." )
ERROR( range_locks_already_unlocked, 2119, "Unlock a range that is not locked." )
