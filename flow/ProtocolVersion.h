...
public: // introduced features
	...
	PROTOCOL_VERSION_FEATURE(0x0FDB00B062FF0000LL, NoKVMemPrefixCompressedSnapshots);
	PROTOCOL_VERSION_FEATURE(0x0FDB00B063000000LL, KVMemPrefixCompressedSnapshots);
