...
public:
	...
	IndexedSet(IndexedSet&& r) noexcept : root(r.root) { r.root = NULL; }
	IndexedSet& operator=(IndexedSet&& r) noexcept { delete root; root = r.root; r.root = 0; return *this; }
...
public:
	...
	void operator=(MapPair&& r) noexcept { key = std::move(r.key); value = std::move(r.value); }
